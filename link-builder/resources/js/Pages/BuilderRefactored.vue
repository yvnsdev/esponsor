                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="hidden sm:flex items-center gap-2 text-sm">
                            <Loader2 v-if="isLoading" class="w-4 h-4 animate-spin text-indigo-600" />
                            <Check v-else-if="!saveError" class="w-4 h-4 text-green-600" />
                            <AlertCircle v-else class="w-4 h-4 text-red-600" />
                            <span class="text-slate-600">{{ saveStatus }}</span>
                        </div>
                        ...
                        <button
                            ...
                            class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors shadow-sm"
                        >
                ...
                <div class="hidden lg:grid lg:grid-cols-12 gap-6">
                    ...
                    <div class="lg:col-span-3 space-y-4">
                        ...
                        <button
                            ...
                            class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-indigo-600 bg-white border-2 border-dashed border-indigo-300 rounded-xl hover:border-indigo-400 hover:bg-indigo-50 transition-all"
                        >
                            <Plus class="w-4 h-4" />
                            <span>Add Block</span>
                        </button>
                    ...
                    <div class="relative inline-block w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                        ...
                        <div class="space-y-2">
                            <button
                                ...
                                class="w-full flex items-center gap-4 p-4 text-left border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group"
                            >
                                <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-indigo-100 group-hover:bg-indigo-200 flex items-center justify-center transition-colors">
                                    <component
                                        v-if="blockType.icon"
